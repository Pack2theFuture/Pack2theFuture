...
export default function SlideMenu({ isOpen, onClose }) {
  ...
  return (
    <div
      className={`fixed top-0 right-0 h-full w-1/2 max-w-sm bg-[#faf7f0] shadow-lg z-[9999] transition-transform duration-300 ${
    ...
    >
      ...
      <div className="px-6 pt-20 pb-10 text-black space-y-10">
        ...
        <div className="flex flex-col items-center space-y-2">
          ...
          <div className="text-lg font-semibold">홍길동님</div>
