...
function Sol() {
    useEffect(() => {
        ...
        // 선택한 거점 id 보내기 
        const id = 1;
        fetch(`https://backend-do9t.onrender.com/api/collections/${id}/`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
        ...
        fetch("https://backend-do9t.onrender.com/api/depart/", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
        ...
        fetch("https://backend-do9t.onrender.com/api/arrive/", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
